...
cv::Mat avframeToCvmat(const AVFrame* frame)
{
    ...
    SwsContext* conversion = sws_getContext(width, height,
...
static int output_video_frame(AVFrame* frame)
{
    ...
    char* video_dst_filename = str;
      ...
      int bufLen = frame->width * frame->height * 3 / 2;
      memcpy(yum_img.data, frame->buf, bufLen * sizeof(unsigned char));

     /* yum_img.step1();
      yum_img.data = (uchar*)frame->data;*/
      //frame->linesize[0];
     // cv::Mat yum_img = avframeToCvmat(frame);
